        ...
        <div className="mx-8 min-h-[800px] h-[800px]">
            <div className="w-full h-full flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-12">
                    ...
                    <h2 className="font-medium text-lg mt-8">Се согласувам дека <u>имам</u> земано производот/службата и дека ќе плаќам до рок на доспевање <u>_____________</u></h2>
            ...
            <div className="static bottom-5 w-full flex justify-between">
                ...
                <div className="flex flex-col h-[100px] w-[350px] justify-between items-center">
                    <h1 className="font-semibold text-xl text-center">Потпис на купувач</h1>
                    <span className="w-[80%] border border-b-dark"></span>
                </div>
            </div>
        </div>
